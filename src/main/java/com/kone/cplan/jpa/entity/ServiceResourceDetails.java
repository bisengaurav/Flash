...
public class ServiceResourceDetails extends AbstractServiceResource implements Serializable {
	...
	@Where(clause =
		"(effectiveenddate >= CURRENT_TIMESTAMP AND effectiveenddate < CURRENT_TIMESTAMP + '14 Days')" +
	...
	@Where(clause = "\"end\" >= CURRENT_TIMESTAMP OR \"end\" IS NULL")
	...
	@Where(clause = "scheduled_start_original__c >= CURRENT_DATE")
